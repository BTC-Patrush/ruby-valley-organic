      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-500 border border-gray-100">
          ...
          <p className="text-center text-gray-600 mb-4">
            Produce grown above 3,000m, nourished by pristine glacial melt. Taste the
            purity of nature, untouched by pollutants.
          </p>
          <a
            href="#"
